...
// Webkit profiling http://bit.ly/ZuyXtI
if(typeof(console.markTimeline) == "undefined") { console.markTimeline = function() { }; } 
...
if(typeof(sessionStorage) == "undefined") { 
  __A(false, "browser has no sessionStorage");
  sessionStorage = {}; 
  sessionStorage.setItem = function() { return; };
  sessionStorage.getItem = function() { return null; };
  sessionStorage.removeItem = function() { return; };
  sessionStorage.key = function() { return null; };
  sessionStorage.clear = function() { return; };
} 
